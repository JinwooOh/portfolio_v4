  ...
  return (
    <div className="desc">
      ...
      <p className="desc__para">
        A weather web application. It uses Wunderground API to gather weather information. A user
        can type a zip code to see specific geolocational information with his or her choice of
        weather unit.
      </p>
...
export function portfoliov4() {
  return (
    <div>
      <h2 className="desc__heading2">Overview</h2>
      <p className="desc__para">
        Yes, this website is also my project. Using React might excessive for a portfolio site, but
        I enjoy writing code instead of writing pure HTML and CSS. One benefit of having a
  ...
  return (
    <div>
      ...
      <p className="desc__para">
        ...
        "What was your most interesting project?" then I would say this. This application was made
        to help my girlfriend who is a stenographer, and she needed a program to compare two text
        files.
      </p>
      <p className="desc__para">
        During the development, I learned the Longest Common Sequence algorithm to compare words,
        and Interestingly, one year later, I heard about the same algorithm in the algorithm class
        at UW-Madison. At the moment, I realized that every topic that I learn from classes could be
  ...
  return (
    <div>
      ...
      <p className="desc__para">
        ...
        took in UW-Madison. This project and theories that I used gave me insight into the
        interaction between a machine and a user.
      </p>
